...
public class AccessPlayerPageController {
    ...
    public void initialize() {
        ...
        /*
        intGiocatore=(HBox) Vboxx.getChildren().get(0);
        ObservableList<String> list = FXCollections.observableArrayList("Selezionare pianeta...", "Mercurio", "Venere", "Terra", "Marte", "Giove", "Saturno", "Urano", "Nettuno");
        choicePianeti.setItems(list);*/
    }
    @FXML
